    ...
    <div className="min-h-screen bg-[#07091F] text-white py-12 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-montserrat font-medium mb-2">
            WEB <span className="text-red-500">APPS</span>
          </h1>
          ...
          <p className="text-gray-400 text-sm sm:text-base max-w-2xl font-montserrat font-medium mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
          {/* VR Movie Phone */}
          <div className="w-32 sm:w-48 h-[300px] sm:h-[400px] bg-gradient-to-b from-purple-900 to-purple-600 rounded-3xl p-2 overflow-hidden opacity-95">
            <div className="h-full rounded-2xl overflow-hidden flex flex-col items-center justify-center text-center p-4">
              <div className="w-20 sm:w-24 h-20 sm:h-24 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 mb-4" />
              <h3 className="text-sm sm:text-lg font-bold mb-2">Watch movies in Virtual Reality</h3>
          ...
          <div className="w-36 sm:w-52 h-[320px] sm:h-[420px] bg-gradient-to-b from-emerald-900 to-emerald-600 rounded-3xl p-2 z-10">
            <div className="h-full bg-black/90 rounded-2xl p-3">
              <div className="space-y-3">
                <h3 className="text-sm sm:text-lg font-bold">What would you like to watch?</h3>
          ...
          {/* Movie Details Phone */}
          <div className="w-32 sm:w-48 h-[300px] sm:h-[400px] bg-gradient-to-b from-gray-900 to-gray-600 rounded-3xl p-2 overflow-hidden opacity-95">
            <div className="h-full bg-black/90 rounded-2xl p-3">
              <div className="space-y-3">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button className="px-4 sm:px-6 py-2 bg-gradient-to-r from-orange-600 to-red-600 rounded text-sm font-semibold hover:opacity-90 transition-opacity">
            Sign Up as User
          </button>
          <button className="px-4 sm:px-6 py-2 bg-gradient-to-r from-orange-600 to-red-600 rounded text-sm font-semibold hover:opacity-90 transition-opacity">
            Sign Up as DJ
