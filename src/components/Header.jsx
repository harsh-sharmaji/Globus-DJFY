...
const Navigation = () => (
  <nav className="relative bg-[#0E113580] text-white border-b border-white/10" style={{
    marginLeft:"32px"
  }}>
    <div className="max-w-7xl mx-auto px-4">
      <div className="flex justify-between items-center py-4">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -bottom-12 " style={{
          top:"-2px"
        }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <h1 className="text-5xl font-montserrat font-medium  text-white flex items-center gap-4">
              ...
              <div className="space-y-6 text-gray-200">
                <p className="text-lg font-montserrat font-normal leading-relaxed">
